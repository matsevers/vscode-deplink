...
export class CargoLinkProvider implements vscode.DocumentLinkProvider, LinkProvider {
    ...
    provideDocumentLinks(document: vscode.TextDocument, token: vscode.CancellationToken): vscode.ProviderResult<vscode.DocumentLink[]> {
        ...
        try {
            ...
            const parsedJson = this.#toml.parse(text);
            const allDependencies = Object.keys(parsedJson.dependencies);
